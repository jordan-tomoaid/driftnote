    ...
    <div className="flex min-h-full flex-col">
      <header className="border-b border-ink/5 bg-drift/80 backdrop-blur-md">
        <div className="mx-auto flex h-14 max-w-3xl items-center px-5">
          <Link
            href="/"
            className="flex items-center gap-2 font-heading font-bold text-ink"
          >
            <span
              aria-hidden
        ...
        <div className="mt-10 space-y-8 text-[15px] leading-relaxed text-ink-soft [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-ink [&_a]:text-signal [&_a]:underline">
          <section className="space-y-3">
            <p>
              ...
              collect on this website and what we do with it. If anything here
              is unclear, email us and we&apos;ll fix the wording.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              join the waitlist. That&apos;s the only personal detail we ask
              for.
            </p>
            <p>
              <strong className="text-ink">Basic analytics and ad data.</strong>{" "}
              We use analytics and advertising tools to understand how people
              find the site and whether an ad led to a signup. Depending on how
              you arrived, this may include the Reddit Pixel, the Meta Pixel,
              Google Analytics 4, and PostHog. These set cookies or similar
              identifiers and share usage signals (such as page views and the
              fact that a signup happened) with those providers. We do not
              upload your email address to any ad network.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc space-y-2 pl-5">
              <li>
                To email you when Driftnote opens up, and about Driftnote only.
              </li>
              <li>To measure whether our ads are working, in aggregate.</li>
              <li>To improve the product based on what early users tell us.</li>
            </ul>
            <p>
              We do not sell your data. We do not send marketing for other
              products.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              host (Formspree) to receive waitlist emails, static hosting to
              serve these pages, and the advertising and analytics tools named
              above for measurement. Each processes data only to provide that
              service.
            </p>
          </section>
          ...
          <section className="space-y-3">
            <h2>Your choices</h2>
            <p>
              You can ask us to delete your email at any time, and every email
              we send includes an unsubscribe link. You can block advertising
              cookies in your browser settings without affecting the site.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              <a href="mailto:hello@driftnote.example">
                hello@driftnote.example
              </a>
              .
            </p>
          </section>
